  ...
  return (
    <div className="navbar gradientSpaceCadet shadow-sm rounded-r-2xl">
      <div className=" h-full py-10 flex flex-col">
        ...
        <div className="w-full h-[48px] mb-16 cursor-pointer">
          <img
        ...
        <IconWrap
          icon={
            <HomeIcon className="w-8 homeIcon " />
          }
        />
        <IconWrap
          icon={
            <BoardIcon className="w-[30px] homeIcon " />
          }
        />
        <IconWrap
          icon={
            <ChatIcon className="w-8 homeIcon " />
          }
        />
        <IconWrap
          icon={
            <FriendsIcon className="w-8 homeIcon " />
          }
        />
        <IconWrap
          icon={
            <GroupIcon className="w-[35px] homeIcon " />
          }
        />
        ...
        <IconWrap
          className="mb-auto"
          icon={
            <ProfileIcon className="w-[28px] homeIcon " />
          }
        />
      </div>
    </div>
